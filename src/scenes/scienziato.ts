 ...
 this._dialogo2Container = this.add.container().setAlpha(0).setDepth(10);
  ...
  this._dialogo7Container.add([
    this._dialogo7ContainerBackground,
     ...
     this.add.text(this.game.canvas.width / 2, 100, "Haha ragazzo, sono uno scienziato, ").setTint(0x00000).setFontFamily('Georgia,"Goudy Booletter 1911",Times,serif').setDepth(10).setScale(1.2).setPosition(240,220),
